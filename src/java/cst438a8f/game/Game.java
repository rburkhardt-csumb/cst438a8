...
public class Game {
    ...
    private ArrayList<Word> wordlist;  // list of words
     ...
     * Add method for random number generation.
     */
     ...
     * @author Roderick Burkhardt
     * Modified method to return a random word from a database table containing
     * words for the game.
     */
    private String randomWord()
    {
        try
        {
            ...
            String word = GameDB.retrieveWord(t); 
            if (word == null)
            {
                return "failure";
            }
